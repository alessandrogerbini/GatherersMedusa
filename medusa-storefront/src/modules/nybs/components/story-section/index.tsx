      ...
      <div className="content-container">
        ...
        <div className="text-center mb-12">
          <div className="border-y-4 border-nybs-black py-4 mb-4">
            <h2 className="nybs-heading-section">
              EXTRA! EXTRA!
              <br />
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="newsprint-card p-6">
            ...
            <p className="nybs-text-body leading-relaxed mt-4">
              ...
              into the snacks you can&apos;t stop reaching for.
            </p>
          </div>
          ...
          <div className="newsprint-card p-6">
            ...
            <p className="nybs-text-body leading-relaxed mt-4">
              ...
              shouting about from the rooftops.
            </p>
          ...
          <div className="newsprint-card p-6">
            ...
            <p className="nybs-text-body leading-relaxed mt-4">
              ...
              Whether you&apos;re a native or just wish you were, these snacks bring the city to you.
            </p>
        ...
        <div className="bg-nybs-black text-white p-8 border-4 border-nybs-red">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-6 max-w-3xl mx-auto">
              From Everything Bagel to Pizza Perfection, we&apos;ve captured New York&apos;s 
              iconic tastes in every bag.
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-sm font-bold">
              <span className="bg-white text-nybs-black px-4 py-2">★ BAGEL INSPIRED</span>
              <span className="bg-white text-nybs-black px-4 py-2">★ PIZZA PERFECT</span>
              <span className="bg-white text-nybs-black px-4 py-2">★ BROOKLYN SPICY</span>
              <span className="bg-white text-nybs-black px-4 py-2">★ SALT &amp; ATTITUDE</span>
            </div>
          </div>
        </div>
