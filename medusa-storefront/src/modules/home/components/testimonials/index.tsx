...
const Testimonials = () => {
  ...
  return (
    <section className="section-container bg-gatherers-orange" aria-labelledby="testimonials-heading">
      <div className="content-container">
        <div className="max-w-4xl mx-auto text-center">
          <h2 id="testimonials-heading" className="text-3xl md:text-4xl font-bold text-white mb-12">
